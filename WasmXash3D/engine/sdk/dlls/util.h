...
#else // CLIENT_DLL
#define LINK_ENTITY_TO_CLASS(mapClassName,DLLClassName) \
void mapClassName##link_callback(entvars_t* t) \
{ GetClassPtr<DLLClassName>((DLLClassName*)t); } \
 static EntityMap mapClassName (#mapClassName, &mapClassName##link_callback);
#endif // CLIENT_DLL
