...
static void FS_PopulateDirEntries( dir_t *dir, const char *path )
{
	...
	//Con_Printf("1Yooe befur direntries\n");
	...
	//Con_Printf("2Yooe befur direntries\n");
	stringlistinit( &list );
	...
	//Con_Printf("3Yooe befur direntries\n");
...
static void FS_Search_DIR( searchpath_t *search, stringlist_t *list, const char *pattern, int caseinsensitive )
{
	...
	basepath = (char*)Mem_Calloc( fs_mempool, basepathlength + 1 );
